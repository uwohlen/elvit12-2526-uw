...
while True:
  ...
  if trykkede_taster[tast.K_q]: # q for quit
    pg.quit()
    sys.exit()
  ...
  firkant_inn = pg.Rect(800,10,200,40)
  pg.key.set_text_input_rect(firkant_inn)
  pg.draw.rect(vindu,"black",firkant_inn,width=1)
