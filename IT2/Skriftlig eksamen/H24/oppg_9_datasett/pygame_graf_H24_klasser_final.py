...
class Knapp(Firkant):
  ...
  Knapper er firkanter med tekst, 
    ...
    Nye metoder:
      vis_tekst: None     setter teksten venstrestilt, sentrert i høyden
  ...
  def vis_tekst(self) -> None:
    """
    Setter teksten venstrestilt på knappen, sentrert i høyden
      Svart farge
    ...
    # luft til venstre settes lik luft i høyden
